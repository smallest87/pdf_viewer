...
class LayerManagerWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.add_layer("Teks Layer (T)", app_state.get_visibility("text_layer"), "text_layer")
        self.add_layer("CSV Overlay (C)", app_state.get_visibility("csv_layer"), "csv_layer")
    ...
    def _sync_layers(self, tag, is_visible):
        ...
        for i in range(self.model.rowCount()):
            ...
            if item.data(Qt.ItemDataRole.UserRole) == tag:
                target_state = Qt.CheckState.Checked if is_visible else Qt.CheckState.Unchecked
